...
| Agent | Description |
|-------|-------------|
| cyberclaw | Default agent for general conversations, daily tasks, coding help, and creative work |
| vault | Memory manager - always query for memory operations (store and retrieve) |
...
- Always use Vault for memory operations - don't read/write memory files directly
- Vault manages the memory axis: topics/ (timeless facts), projects/ (project context), daily-notes/ (events)
